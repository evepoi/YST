...
[Next Release 내용]
1. 공통객차의 passenger_wagon의 열차 고유 ID 수정예정.
2. 한국선로셋 준고속선 추가로 251km/h -> 260km/h 상향조정
3. YN열차이름 TAE로 변경예정. (열차 고유 ID 변경예정.)
4. YTRO열차이름 YMT로 변경예정. (열차 고유 ID변경예정.)
5. 매개변수에서 나라별 열차사용여부 체크기능 추가
6. 열차별 고유 숫자 ID 부여. 지속적인 업데이트시 열차 편성 오류방지목적임.
