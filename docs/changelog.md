...
[신규객차]
- 쇼케이스용 평판화차 포터2 (#88)
=> 쇼케이스용은 수송량은 없고 유지비만 있습니다.

[도색추가]
- 객차형 2층 화차 (#79), (#80)
- 평판화차 녹색도색 컨테이터 추가 (#83)
- HYEL-100 아이언맨 도색 추가(#84)
- YFX 윙바디 적재 중 화물 추가 (#85)
- HYEL-100 K-리무진 도색추가(#86)
- 객차형 2층 화차 (#87)

[명칭변경]
- YPW -> 중국열차 25형 변경 /영어 (China Railway Type 25)

[스팩변경]
- 1층 공통객차 등장년도 1978 -> 1964 조정
