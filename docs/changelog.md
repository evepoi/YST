...
[변경]
- 깃허브 열차 목록 나라별로 구분함.
- 열차이름 변경 AVE -> Renfe S-100
- 열차이름 변경 AVE Velaro -> Renfe S-103
- 열차이름 변경 CRH362A -> CRH380A
- 열차이름 변경 CRH600A-Test -> CRH380AJ
- 열차이름 변경 CRV600 -> CR400
- 열차이름 변경 E300 -> 유로스타 E300
- 열차이름 변경 E320 -> 유로스타 E320
- 중국형 열차 CRH600A -> 테스트 차량 사용여부 구분으로 변경
- 일본형 열차 Dr. Yellow -> 테스트 차량 사용여부 구분으로 변경
- 기관차는 구분안하고 모두 복합열차구성 가능하도록 변경함.
